...
else
{
 ...
 if(isset($_POST['update_update_btn'])){
  ...
  $update_quantity_query = mysqli_query($conn, "UPDATE `product` SET quantity = '$quantity' , name='$name' ,price='$price'  WHERE id = '$update_id'");
  ...
  <?php
    ...
    <tr>
     ...
     <form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post">
      ...
      <td><a href="all_product.php?remove=<?php echo $row['id']; ?>"><img src="images/remove.png" alt="remove" width="20px" height="20px"></a></td>
    </tr>
    <?php 
    }
        } 
